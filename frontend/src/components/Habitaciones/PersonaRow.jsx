...
const PersonaRow = ({ persona, totalHabitacion, cantidadPersonas, onRegistrarPago, onMover }) => {
  ...
  return (
    <div className={styles.personaRow}>
      <div>
        ...
        <div className={styles.personaPagos}>{persona.pagos.map((pago, index) => `${pago.mes} ${formatCurrency(pago.monto)}`).join(' · ') || 'Sin pagos'}</div>
      </div>
